...
MANUAL_TAREAS = (
    ...
    "• Al agregarla le pregunto la prioridad: de ⭐ a ⭐⭐⭐⭐⭐ (o sin estrellas). "
    "Las más importantes quedan arriba\n"
    "• También puede decirla: \"tarea urgente pagar la luz, 5 estrellas\"\n"
    "• Verlas: \"mostrame la lista\" (o \".tareas\") → cada tarea es un botón\n"
    "• Eliminar: toque la tarea en la lista (o \".2\", o \"borrá la tarea 2\")\n"
    "• Editar: \"renombrá la tarea 1...\", \"ponele 3 estrellas a la tarea 2\"\n\n"
    "*⏰ Recordatorios*\n"
    "• \"recordame llamar al médico mañana a las 3\"\n"
